...
return (
  <div className="page">
    <header className="topbar">
      <div className="title">Radio TX Studio - THM, Friedberg</div>
      <div className="subtitle">Stream WAV → GNU Radio (ZMQ)</div>
    </header>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <div>
              ...
              <button className="btn ghost" onClick={pause}>STOP </button>
            </div>
          </div>
      ...
      <aside className="right">
        ...
        <div className="card small muted-note">
          ...
          <ul>
            ...
            <li>Backend streams file bytes via ZMQ to GNU Radio</li>
            <li>Make sure GNU Radio ZMQ Audio Input listens on the configured host/port</li>
          </ul>
        </div>
      </aside>
    </main>

    <footer className="foot">THM Radio - Built By PRATIK DAS for CASE STUDY MODULE</footer>
  </div>
);
}
